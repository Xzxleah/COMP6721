...
trained_models: includes the saved trained models generated by the original training code and a new improved training code,
		The testing dataset with corresponding five mask categories and The test codes whose name are test_partI.ipynb and test_partII.ipynb
		The test code of both the original one and the new one can be run directly by using the juptyer notebook,
	      	Both of Tthe test codes will provide the best testing performance of our trained model and The evaluation performance can be immediately seen after running the code.
